...
class ProxyPool {
    ...
    /** Returns the original Node fetch (saved before override), or globalThis.fetch as fallback. */
    get originalFetch(): typeof fetch {
        return this._originalFetch || globalThis.fetch;
    }
