...
// Derived from the shared registries so formats upstream adds (e.g. the Opus
// tier) become valid CLI qualities/containers without a second list to update.
export const CUSTOM_FORMAT_NAMES: string[] = Object.keys(CUSTOM_FORMATS);
export const CONTAINER_FORMAT_NAMES: string[] = Object.keys(CONTAINER_FORMATS);
